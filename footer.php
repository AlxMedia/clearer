					...
					<div id="footer-bottom">
						...
						<div class="pad group">
							...
							<div class="grid one-full">
								...
								<div id="credit">
									<p><?php esc_html_e('Powered by','clearer'); ?> <a href="<?php esc_url( _e( 'https://wordpress.org', 'clearer' ) ); ?>" rel="nofollow">WordPress</a>. <?php esc_html_e('Theme by','clearer'); ?> <a href="https://agnarson.com" rel="nofollow">Alx</a>.</p>
								</div><!--/#credit-->
								<?php endif; ?>
